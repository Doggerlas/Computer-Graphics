...
from script.loader import SketchReader
import os
import argparse
...
def convert_model():
    ...
    input_graph_path = '../output/train_geomNet/savedModel/my_model498000.ckpt.meta'
    ...
    print(input_graph_path, input_saver_def_path, input_binary, input_checkpoint_path,output_node_names, restore_op_name, filename_tensor_name, output_graph_path,clear_devices)
